...
class Brand(models.Model):
    ...
    logo = models.ForeignKey(Image, null=True, blank=True, on_delete=models.PROTECT, related_name='brand_of_logo', default=None)
...
def brand_pre_save(sender, instance : Image, raw, using, **kwargs):
